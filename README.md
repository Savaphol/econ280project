...
3.	Note that the above code performs the two-sample two-stage least squares as in Chodorow-Reich and Wieland (2019) and requires the user to copy and paste the .ado and the helper files provided by the author in their Stata personal directory.
